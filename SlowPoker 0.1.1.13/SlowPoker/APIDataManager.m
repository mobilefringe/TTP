...
-(id)updateGame:(NSString*)jsonData {
    ...
    NSMutableDictionary *updateGameResults = [self requestAPIData:jsonData url:urlAddress];
    //NSLog(@"updateGame results:%@",game);
...
-(id)requestAPIData:(NSString *)json url:(NSString*)postUrl
{
    ...
    NSError *error;
    /*
    if([postUrl isEqualToString:@"http://www.texasturnpoker.com/getLastMessage"]){
