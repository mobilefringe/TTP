...
@class InviteFacebookFriendsViewController;
@class Avatar;
...
@interface AppDelegate : UIResponder <UIApplicationDelegate,MFMailComposeViewControllerDelegate,TwitterDialogDelegate,TwitterLoginDialogDelegate>{
    ...
    int logginAttempts;
    InviteFacebookFriendsViewController *inviteFacebookFriendsViewController;
    Avatar *showImage;
...
@property (nonatomic, retain)InviteFacebookFriendsViewController *inviteFacebookFriendsViewController;
@property (nonatomic, retain)Avatar *showImage;
