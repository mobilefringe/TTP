...
- (void)loadView
{
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        background.frame =CGRectMake(0, 0, 320, [UIImage imageNamed:@"bet_view_background.png"].size.height/2);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        potLabel.frame =CGRectMake(0, 6+25, 320, 22);
    }
    ...
    self.potCommitmentValue = [[UILabel alloc] initWithFrame:CGRectMake(45, 16, 230,26)];
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        potCommitmentValue.frame = CGRectMake(45, 19+25, 230,26);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        lastActionMessage.frame = CGRectMake(45, 120+30, 230,26);
    }
    ...
    self.lastActionMessageLabel = [[UILabel alloc] initWithFrame:CGRectMake(45, 133, 230,26)];
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        lastActionMessageLabel.frame = CGRectMake(45, 135+30, 230,26);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        communityCardOne.frame =CGRectMake(15, 70, 35*1.5, 49*1.5);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        communityCardTwo.frame =CGRectMake(15+xOffset, 70, 35*1.5, 49*1.5);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        communityCardThree.frame =CGRectMake(15+xOffset*2, 70, 35*1.5, 49*1.5);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        communityCardFour.frame =CGRectMake(15+xOffset*3, 70, 35*1.5, 49*1.5);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        communityCardFive.frame =CGRectMake(15+xOffset*4, 70, 35*1.5, 49*1.5);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        foldButton.frame = CGRectMake(20, 258+yoffset+60, 135, 50);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        checkCallButton.frame = CGRectMake(165, 258+yoffset+60, 135, 49);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        decreaseBuyIn.frame = CGRectMake(20, 325+yoffset+70, 40, 40);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        raiseButton.frame = CGRectMake(70, 320+yoffset+70, 180, 50);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        increaseBuyIn.frame = CGRectMake(260, 325+yoffset+70, 40, 40);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        raiseSlider.frame = CGRectMake(20, 385+yoffset+70, 280, 20);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        userBarView.frame =CGRectMake(0, 432, userBar.size.width/2, userBar.size.height/2);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        dealerButton.frame = CGRectMake(248, 330+70, 40, 40);
    }
