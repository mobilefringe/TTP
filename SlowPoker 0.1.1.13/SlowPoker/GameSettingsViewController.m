...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if(section == 1){
        ...
        CellHeaderGeneral *header = [[CellHeaderGeneral alloc] initWithFrame:CGRectMake(0, 0, 320, 35) title:[NSString stringWithFormat:@"%d Players",numOfPlayers]];
        return header;
    }else if(section == 0){
        if([@"cash" isEqualToString:gameType]){
            CellHeaderGeneral *header = [[CellHeaderGeneral alloc] initWithFrame:CGRectMake(0, 0, 320, 35) title:@"Cash Game Settings"];
            return header;
            
        }else if([@"tournament" isEqualToString:gameType]){
            CellHeaderGeneral *header = [[CellHeaderGeneral alloc] initWithFrame:CGRectMake(0, 0, 320, 35) title:@"Tournament Game Settings"];
            return header;
        }
        CellHeaderGeneral *header = [[CellHeaderGeneral alloc] initWithFrame:CGRectMake(0, 0, 320, 35) title:@"Their Turn"];
        return header;
    }
    return nil;
