...
-(void)loadView{
    ...
    UIImageView *backgroundView = [[UIImageView alloc] initWithImage:woodFloor];
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        _tableView.frame = CGRectMake(0, 0, 320, 509-40);
    }
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    if(section == 0){
        CellHeaderGeneral *header = [[CellHeaderGeneral alloc] initWithFrame:CGRectMake(0, 0, 320, 35) title:@"Chip Leaders"];
        ...
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"HANDS_WON"];
        [header setHeaderCode:@"HANDS_WON"];
        return header;
        
    }else if(section == 2+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"VPIP"];
        [header setHeaderCode:@"VPIP"];
        return header;
        
    }else if(section == 3+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"PFR"];
        [header setHeaderCode:@"PFR"];
        return header;
    }else if(section == 4+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"PFA"];
        [header setHeaderCode:@"PFA"];
        return header;
    }else if(section == 5+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"WTSD"];
        [header setHeaderCode:@"WTSD"];
        return header;
    }else if(section == 6+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"W$SD"];
        [header setHeaderCode:@"W$SD"];
        return header;
    }else if(section == 7+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"WWSD"];
        [header setHeaderCode:@"WWSD"];
        return header;
        
    }else if(section == 8+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"Fold %"];
        [header setHeaderCode:@"FOLD"];
        return header;
        
    }else if(section == 9+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"See Flop %"];
        [header setHeaderCode:@"SEE_FLOP"];
        return header;
        
    }else if(section == 10+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"See Turn %"];
        [header setHeaderCode:@"SEE_TURN"];
        return header;
        
    }else if(section == 11+i){
        GameStatCellHeader *header = [[GameStatCellHeader alloc] initWithFrame:CGRectMake(0, 0, 320, 58) title:@"See River %"];
