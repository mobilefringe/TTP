...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.title = [[UILabel alloc] initWithFrame:CGRectMake(83, 12, 210, 25)];
        title.textColor = [UIColor colorWithRed:1 green:1 blue:.3 alpha:1];
        title.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:22.0];
        title.tag = 10;
        ...
        self.description = [[UILabel alloc] initWithFrame:CGRectMake(83, 36, 195, 60)];
        description.textColor = [UIColor whiteColor];
        description.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:11.0];
...
-(void)setData:(BOOL)isCash{
    if(isCash){
        ...
        description.text = @"At least 2 players needed to start. Players can buy into an active game and can re-buy if they lose their $";
    }else{
