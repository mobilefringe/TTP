...
- (id)initWithFrame:(CGRect)frame delegate:(id)delegate
{
    ...
    if (self) {
        ...
        viewHandButton.frame = CGRectMake(35, 275+15+50, 120, 40);
        ...
        dealNewHandButton.frame = CGRectMake(165, 275+15+50, 120, 40);
        ...
        closeButton.frame = CGRectMake(75, 275+15+50, 175, 40);
        ...
        self.showHandButton = [MFButton buttonWithType:UIButtonTypeCustom];
        showHandButton.frame = CGRectMake(75, 275+15, 175, 40);
        [showHandButton setImage:[[UIImage imageNamed:@"blue_wide.png"] stretchableImageWithLeftCapWidth:24 topCapHeight:15] forState:UIControlStateNormal];
        //[canclelButton setTitle:@"Check" forState:UIControlStateNormal];
        //[checkCallButton setBackgroundColor:[UIColor colorWithRed:0.1 green:0.3 blue:0.5 alpha:1]];
        [showHandButton addTarget:delegate action:@selector(showYourHand) forControlEvents:UIControlEventTouchUpInside];
        [self addSubview:showHandButton];
        
        UILabel *showHandLabel = [[UILabel alloc] initWithFrame:showHandButton.bounds];
        showHandLabel.font = [UIFont boldSystemFontOfSize:18];
        showHandLabel.textAlignment = UITextAlignmentCenter;
        showHandLabel.backgroundColor = [UIColor clearColor];
        showHandLabel.textColor = [UIColor whiteColor];
        showHandLabel.adjustsFontSizeToFitWidth = YES;
        showHandLabel.minimumFontSize = 12;
        showHandLabel.text = @"Show Your Hand";
        [showHandButton addSubview:showHandLabel];
...
-(void)showHandSummary:(NSMutableDictionary *)hand showNewHand:(BOOL)showNewHand delay:(double)delay{
    [DataManager sharedInstance].showHand = hand;
    delay = delay + 0.7;
