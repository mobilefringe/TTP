...
-(void)loadView{
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        scroll.frame = CGRectMake(0, 0, 320, 505);
    }
    scroll.backgroundColor = [UIColor clearColor];
    scroll.contentSize = CGSizeMake(320, 661);
    [self.view addSubview:scroll];
    
    
    self.feedbackButton = [MFButton buttonWithType:UIButtonTypeCustom];
    feedbackButton.frame = CGRectMake(25, 284+112+61, [UIImage imageNamed:@"home_feedback_button.png"].size.width/2, [UIImage imageNamed:@"home_feedback_button.png"].size.height/2);
    [feedbackButton addTarget:self action:@selector(pressFeedback) forControlEvents:UIControlEventTouchUpInside];
    [feedbackButton setTitle:@"TTP Facebook" forState:UIControlStateNormal];
    [feedbackButton setImage:[UIImage imageNamed:@"home_feedback_button.png"] forState:UIControlStateNormal];
    [scroll addSubview:feedbackButton];
    
    UILabel *feedbackLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 124, 170, 50)];
    feedbackLabel.backgroundColor = [UIColor clearColor];
    feedbackLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:26.0];
    feedbackLabel.textAlignment = UITextAlignmentLeft;
    ...
    UILabel *facebookLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 124, 170, 50)];
    facebookLabel.backgroundColor = [UIColor clearColor];
    facebookLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:26.0];
    ...
    UILabel *twitterLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 124, 170, 50)];
    twitterLabel.backgroundColor = [UIColor clearColor];
    twitterLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:26.0];
    ...
    UILabel *leaderboardLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 124, 175, 50)];
    leaderboardLabel.backgroundColor = [UIColor clearColor];
    leaderboardLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:25.0];
    ...
    UILabel *myProfileLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 124, 170, 50)];
    myProfileLabel.backgroundColor = [UIColor clearColor];
    myProfileLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:26.0];
    ...
    UILabel *myFriendsLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 124, 170, 50)];
    myFriendsLabel.backgroundColor = [UIColor clearColor];
    myFriendsLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:26.0];
    ...
    UILabel *proPointsLabel = [[UILabel alloc] initWithFrame:CGRectMake(30, 124, 170, 50)];
    proPointsLabel.backgroundColor = [UIColor clearColor];
    proPointsLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:26.0];
    ...
    gamesButtonLabel.font = [UIFont fontWithName:[Settings sharedInstance].header1Font size:26.0];
