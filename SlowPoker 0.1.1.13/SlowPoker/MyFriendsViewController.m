...
-(void)viewWillDisappear:(BOOL)animated{
    [[DataManager sharedInstance] removeObserver:self forKeyPath:@"profileStatues" context:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.row == 0){
        ...
        playerData = [[DataManager sharedInstance].myFriends objectAtIndex:indexPath.row-1];
    }
    ...
    if(!cell.isFacebookInstructions && !cell.isContactsInstructions && !cell.isEmailInstructions){
        Avatar *avatar = [[Avatar alloc] initWithFrame:CGRectMake(16, 7, 55, 55)];
