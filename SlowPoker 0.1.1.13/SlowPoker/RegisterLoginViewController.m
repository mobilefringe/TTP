...
- (void)loadView
{
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        loginUser.frame = CGRectMake(140, 255, [UIImage imageNamed:@"login_button.png"].size.width/2, [UIImage imageNamed:@"login_button.png"].size.height/2);
    }
    ...
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        newUser.frame = CGRectMake(-40, 120+55, [UIImage imageNamed:@"new_user_button.png"].size.width/2, [UIImage imageNamed:@"new_user_button.png"].size.height/2);
    }
