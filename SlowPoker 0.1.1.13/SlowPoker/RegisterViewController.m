...
- (void)loadView
{
    ...
    buyGiftMFButton.frame = CGRectMake(85, 275+115, 150, 40);
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        buyGiftMFButton.frame = CGRectMake(85, 275+115+35, 150, 40);
    }
    ...
    UILabel *or = [[UILabel alloc] initWithFrame:CGRectMake(20, 217, 280, 22)];
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        or.frame = CGRectMake(20, 217+25, 280, 22);
    }
    ...
    self.twitterFacebookInstructions = [[UILabel alloc] initWithFrame:CGRectMake(10, 402+y3, 300, 35)];
    ...
    twitterFacebookInstructions.numberOfLines = 2;
    twitterFacebookInstructions.text = @"Register using your Twitter or Facebook accounts. Earn 100 Free Pro Chips when registering with Facebook.";
    twitterFacebookInstructions.font = [UIFont boldSystemFontOfSize:11];
    [background addSubview:twitterFacebookInstructions];
    
    
    self.twitterButton = [UIButton buttonWithType:UIButtonTypeCustom];
    twitterButton.frame = CGRectMake(9, 350+y3, [UIImage imageNamed:@"twitter_button.png"].size.width/2, [UIImage imageNamed:@"twitter_button.png"].size.height/2);
    ...
    facebookButton.frame = CGRectMake(170, 350+y3, [UIImage imageNamed:@"facebook_button.png"].size.width/2, [UIImage imageNamed:@"facebook_button.png"].size.height/2);
    ...
    UIImageView *image2 = [[UIImageView alloc] initWithFrame:CGRectMake(260, 85, 60, 60)];
    if ([[UIScreen mainScreen] bounds].size.height > 480.0f){
        image2.frame = CGRectMake(260, 85+25, 60, 60);
    }
    image2.image = [UIImage imageNamed:@"facebook_promo.png"];
    [background addSubview:image2];
...
-(void)registerUser{
    ...
    if([password.text length] < 6){
        ...
        validation.message = @"Your password must be at least 6 characters long";
        [validation show];
        return;
    }
