...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.userNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(72, 43, 138, 30)];
        ...
        self.timerLabel = [[UILabel alloc] initWithFrame:CGRectMake(25+20, 22, 60, 15)];
        ...
        self.timerIcon = [[UIImageView alloc] initWithFrame:CGRectMake(12+20, 24, 11, 11)];
        ...
        UILabel *nudgeLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, 0, 132-10, 28)];
        ...
        nudgeLabel.text = @"Nudge Player";
        nudgeLabel.backgroundColor = [UIColor clearColor];
        [nudgeButton addSubview:nudgeLabel];
        
        self.betButtonLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, 0, 132-10, 28)];
        ...
        self.dealerButton = [[UIImageView alloc] initWithFrame:CGRectMake(69, 18, 20, 20)];
...
-(void)setCellData:(NSMutableDictionary *)dataDict chipStackState:(int)chipStackState{
    ...
    if([dataDict objectForKey:@"MY_BET_ROUND"] && [@"YES" isEqualToString:[dataDict objectForKey:@"MY_BET_ROUND"]]){
        ...
        if(amount == 0){
            ...
            if([@"raise" isEqualToString:[dataDict objectForKey:@"action"]] || [@"bet" isEqualToString:[dataDict objectForKey:@"action"]] || [@"reraise" isEqualToString:[dataDict objectForKey:@"action"]]){
    ...
    */
    ...
    betButtonLabel.text = [NSString stringWithFormat:@"%@/%@/%@",@"Fold",callString,raiseString];
    
    
    if([DataManager sharedInstance].isDebugMode){
        NSMutableDictionary *player = [[DataManager sharedInstance] getPlayerForIDCurrentGame:[dataDict valueForKey:@"userID"]];
        userNameLabel.text = [NSString stringWithFormat:@"%@ - %@ - %@",[player valueForKey:@"order"],userNameLabel.text,[dataDict valueForKey:@"userID"]];
    }
}
