...
@class InvitePlayerToGameViewController;
...
@interface TurnsViewController : SlowPokerViewController<UITableViewDelegate,UITableViewDataSource,UIActionSheetDelegate,UITextFieldDelegate,UIAlertViewDelegate>{
    ...
    BOOL vibeForYourTurn;
    UIAlertView *cantDeleletGame;
    BOOL fromBetView;
    int screenMax;
    InvitePlayerToGameViewController *invitePlayerToGameViewController;
...
@property (nonatomic,retain)InvitePlayerToGameViewController *invitePlayerToGameViewController;
@property (readwrite)BOOL userWantsToDelete;
@property (readwrite)BOOL fromBetView;
