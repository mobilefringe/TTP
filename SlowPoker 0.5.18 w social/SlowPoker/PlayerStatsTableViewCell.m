...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        handsLabel.textColor = [UIColor darkGrayColor];
        ...
        gamesLabel.textColor = [UIColor darkGrayColor];
        ...
        cashEarningsLabel.textColor = [UIColor darkGrayColor];
        ...
        tournamentsLabel.textColor = [UIColor darkGrayColor];
        ...
        gamesValueLabel.textColor = [UIColor colorWithRed:0.2 green:0.4 blue:0.8 alpha:1];
        ...
        handsValueLabel.textColor = [UIColor colorWithRed:0.2 green:0.4 blue:0.8 alpha:1];
        ...
        cashValueEarningsLabel.textColor = [UIColor colorWithRed:0.2 green:0.4 blue:0.8 alpha:1];
        ...
        tournamentsValueLabel.textColor = [UIColor colorWithRed:0.2 green:0.4 blue:0.8 alpha:1];
