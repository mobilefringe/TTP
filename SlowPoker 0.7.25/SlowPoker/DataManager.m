...
-(id)init{
	...
	if (self != nil) {
        ...
        [cardImages setValue:[UIImage imageNamed:@"backside_card1.png"] forKey:@"?"];
...
-(NSMutableDictionary *)registerPlayer:(NSMutableDictionary *)playerData{
    ...
    if([@"1" isEqualToString:[results objectForKey:@"success"]]){
        ...
        if(![self currentUserHasAchievement:earnedAchievement]){
        ...
        for (NSMutableDictionary *player in [[currentGame valueForKey:@"turnState"] valueForKey:@"players"]) {
            ...
            for (NSMutableDictionary *winner in winners) {
                if([[winner valueForKey:@"userID"] isEqualToString:[player valueForKey:@"userID"]]){
                    ...
                    if(winAmount > 0){
                        NSString *message = [NSString stringWithFormat:@"You won $%.2f!",winAmount] ;
                        NSMutableDictionary *payLoad = [[NSMutableDictionary alloc] init];
                        [payLoad setValue:currentGameID forKey:@"gameID"];
...
-(void)offerRematch:(NSMutableDictionary *)game{
    ...
    [FlurryAnalytics logEvent:@"CREATE_GAME" withParameters:[game valueForKey:@"gameSettings"]];
    NSString *message = [NSString stringWithFormat:@"%@ has invited you to a %@ game",myUserName,NSLocalizedString([[rematchGame valueForKey:@"gameSettings"] valueForKey:@"type"],nil)] ;
    NSMutableDictionary *payLoad = [[NSMutableDictionary alloc] init];
    [payLoad setValue:currentGameID forKey:@"gameID"];
    [self sendAPN:invitePlayers message:message payLoad:payLoad];
