...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        background.frame = CGRectMake(-10, 0, 320, 68);
        ...
        self.lockIcon = [[UIImageView alloc] initWithFrame:CGRectMake(278, 4, 12, 15)];
