...
- (void)loadView
{
    ...
    self.emailBackground = [[UIImageView alloc] initWithFrame:CGRectMake(20, 140+y, 280, 30)];
    ...
    */
    ...
    forgotPasswordButton.frame = CGRectMake(17, 275+10, 135, 40);
    ...
    buyGiftMFButton.frame = CGRectMake(165, 275+10, 135, 40);
