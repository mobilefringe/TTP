...
static NSString *proChipdentifier1 = @"com.mobilefringe.SlowPoker.noAds";
static NSString *proChipdentifier2 = @"com.mobilefringe.SlowPoker.prochip";
static NSString *proChipdentifier3 = @"com.mobilefringe.SlowPoker.prochip5x";
static NSString *proChipdentifier4 = @"com.mobilefringe.SlowPoker.prochip10x";
static NSString *proChipdentifier5 = @"com.mobilefringe.SlowPoker.prochip50x";
...
- (void)productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response
{
   ...
   // NSLog(@"iTunes Products:%@",theProducts);
