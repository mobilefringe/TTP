...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.proChipsTitle = [[UILabel alloc] initWithFrame:CGRectMake(167, 17, 100, 30)];
        ...
        proChipsTitle.font = [UIFont boldSystemFontOfSize:24];
        [self.contentView addSubview:proChipsTitle];
        
        self.buyDescription = [[UILabel alloc] initWithFrame:CGRectMake(115, 43, 170, 60)];
        ...
        buyDescription.font = [UIFont boldSystemFontOfSize:12];
