...
@interface LoginViewController : UIViewController<UIActionSheetDelegate,UITextFieldDelegate,TwitterDialogDelegate,TwitterLoginDialogDelegate>{
    ...
    UIAlertView *resetPasswordAlert;
}
...
@property(nonatomic,retain)UIAlertView *resetPasswordAlert;
