    ...
    if(indexPath.section == 0){
        ...
        if(indexPath.section == 0 && indexPath.row == 0){
            ...
            if([[DataManager sharedInstance] isGameTypeCash:game]){
                ...
                cell.detailTextLabel.text = [NSString stringWithFormat:@"$%.2f",[[[game objectForKey:@"gameSettings"] objectForKey:@"maxBuy"] floatValue]];
            }
            ...
            if([[DataManager sharedInstance] isGameTypeCash:game]){
                ...
                cell.textLabel.text = @"Blinds Double";
                cell.detailTextLabel.text = [NSString stringWithFormat:@"Every %d hands (%d)",[[[game objectForKey:@"gameSettings"] objectForKey:@"numOfHands"] intValue],[[[game valueForKey:@"gameState"] valueForKey:@"hands"] count]];
            }
        }
