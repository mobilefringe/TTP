...
@interface BetViewController : UIViewController{
    ...
    UILabel *callLabel;
    UILabel *raiseLabel;
    MSLabel *potCommitment;
    UILabel *potCommitmentValue;
    
    UILabel *lastActionMessage;
    UILabel *lastActionMessageLabel;
}
...
@property (nonatomic,retain)MSLabel *potCommitment;
@property (nonatomic,retain)UILabel *potCommitmentValue;
@property (nonatomic,retain)UILabel *lastActionMessage;
@property (nonatomic,retain)UILabel *lastActionMessageLabel;
